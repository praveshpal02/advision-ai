...
export default function UploadBox({ onImageUpload, currentImage }: UploadBoxProps) {
  ...
  const handleRemoveImage = useCallback(() => {
    ...
    const fileInput = document.getElementById('reference-ad-upload') as HTMLInputElement;
    if (fileInput) {
      fileInput.value = '';
    }
  }, [onImageUpload]);
